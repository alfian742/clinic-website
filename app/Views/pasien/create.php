            ...
            <div class="row">
                <div class="col">
                    <div class="form-group row my-3">
                        ...
                        <div class="col-sm-9">
                            <input type="number" class="form-control <?= session('errors.id') ? 'is-invalid' : ''; ?>" id="id" name="id" value="<?= old('id'); ?>" autofocus>
                    ...
                    <div class="form-group row my-3">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control <?= session('errors.tempat_lahir') ? 'is-invalid' : ''; ?>" id="tempat_lahir" name="tempat_lahir" value="<?= old('tempat_lahir'); ?>">
                            <div class="invalid-feedback">
                    ...
                    <div class="form-group row my-3">
                        ...
                        <div class="col-sm-9">
                            <input type="date" class="form-control <?= session('errors.tanggal_lahir') ? 'is-invalid' : ''; ?>" id="tanggal_lahir" name="tanggal_lahir" value="<?= old('tanggal_lahir'); ?>">
                            <div class="invalid-feedback">
                    ...
                    <div class="form-group row my-3">
                        ...
                        <div class="col-sm-9">
                            <select class="form-control <?= session('errors.pekerjaan') ? 'is-invalid' : ''; ?>" id="pekerjaan" name="pekerjaan">
                                ...
                                <option value="Pegawai BUMN" <?= old('pekerjaan') === 'Pegawai BUMN' ? 'selected' : ''; ?>>Pegawai BUMN</option>
                                <option value="Pegawai BUMS" <?= old('pekerjaan') === 'Pegawai BUMS' ? 'selected' : ''; ?>>Pegawai BUMS</option>
                    ...
                    <div class="form-group row my-3">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control <?= session('errors.no_telepon') ? 'is-invalid' : ''; ?>" id="no_telepon" name="no_telepon" value="<?= old('no_telepon'); ?>">
                            <div class="invalid-feedback">
