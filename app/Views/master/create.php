            ...
            <div class="row">
                <div class="col">
                    <div class="form-group row my-3">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control <?= session('errors.id') ? 'is-invalid' : ''; ?>" id="id" name="id" value="<?= $uniqueID; ?>" readonly>
                        ...
                        <div class="col-sm-9">
                            <select class="form-control <?= session('errors.id_tenaga_medis') ? 'is-invalid' : ''; ?>" id="id_tenaga_medis" name="id_tenaga_medis" style="width: 100%;">
                                ...
                                <?php foreach ($tenagaMedis as $tMedis) : ?>
                                    <option value="<?= $tMedis['id']; ?>" <?= old('id_tenaga_medis') == $tMedis['id'] ? 'selected' : ''; ?>>
                        ...
                        <div class="col-sm-9">
                            <select class="form-control <?= session('errors.id_nama_pelayanan') ? 'is-invalid' : ''; ?>" id="id_nama_pelayanan" name="id_nama_pelayanan">
                                ...
                                <?php foreach ($namaPelayanan as $nPelayanan) : ?>
                                    <option value="<?= $nPelayanan['id']; ?>" <?= old('id_nama_pelayanan') == $nPelayanan['id'] ? 'selected' : ''; ?>>
                        ...
                        <div class="col-sm-9">
                            <select class="form-control <?= session('errors.id_jenis_pelayanan') ? 'is-invalid' : ''; ?>" id="id_jenis_pelayanan" name="id_jenis_pelayanan">
                                ...
                                <?php foreach ($jenisPelayanan as $jPelayanan) : ?>
                                    <option value="<?= $jPelayanan['id']; ?>" <?= old('id_jenis_pelayanan') == $jPelayanan['id'] ? 'selected' : ''; ?>>
                    ...
                    <div class="form-group row my-3">
                        ...
                        <div class="col-sm-9">
                            <input type="number" class="form-control <?= session('errors.no_bpjs') ? 'is-invalid' : ''; ?>" id="no_bpjs" name="no_bpjs" value="<?= old('no_bpjs'); ?>">
                            <div class="invalid-feedback">
