...
<div class="container-fluid">
    ...
    <div class="container">
        ...
        <form action="<?= base_url('tenagamedis/save'); ?>" method="POST">
            <?= csrf_field(); ?>
            <div class="row">
                <div class="col">
                    ...
                    <div class="form-group row my-3">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control <?= session('errors.jabatan') ? 'is-invalid' : ''; ?>" id="jabatan" name="jabatan" value="<?= old('jabatan'); ?>">
                            <div class="invalid-feedback">
